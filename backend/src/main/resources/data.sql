...
-- Instruments
INSERT INTO instruments (id, instrument_id, manufacturer, model, serial_number, capacity_range, accuracy, year_of_manufacture, usage, status, establishment_id, created_at, updated_at) VALUES
('f0000001-0000-0000-0000-000000000001', 'LM-INST-2026-000001', 'Avery India', 'WS-500', 'SN-12345', '0-500kg', 'Class III', 2024, 'Commercial weighing', 'REGISTERED', 'e0000001-0000-0000-0000-000000000001', NOW(), NOW());
