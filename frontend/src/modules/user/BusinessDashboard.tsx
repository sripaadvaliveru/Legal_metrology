...
import { Package, FileText, CheckCircle, AlertTriangle, Clock, Loader2 } from 'lucide-react';
...
export default function BusinessDashboard() {
  ...
  const stats = [
    ...
    { label: 'Verified', value: kpis?.verifiedInstruments ?? 0, icon: CheckCircle, color: 'bg-green-500' },
    { label: 'Pending Applications', value: kpis?.pendingApplications ?? 0, icon: FileText, color: 'bg-yellow-500' },
    { label: 'Expiring Soon', value: kpis?.expiringSoon ?? 0, icon: Clock, color: 'bg-orange-500' },
    { label: 'Expired', value: kpis?.expiredInstruments ?? 0, icon: AlertTriangle, color: 'bg-red-500' },
  ];
